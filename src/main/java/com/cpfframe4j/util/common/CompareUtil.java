...
//        if (list1 == null || list1.isEmpty() || list2 == null || list2.isEmpty() || StringUtil.isBlank(flagfield)
//                || comparefields == null) {
//            return;
//        }
//
...
//            String flagvalue = record1.getStr(flagfield);
...
//    }
//
//    public static void compareListNullFill(List<Record> list1, List<Record> list2, String flagfield,
...
//        if (StringUtil.isNotBlank(flagfield) && StringUtil.isNotBlank(flagvalue) && list != null) {
//            for (T item : list) {
//                if (flagvalue.equals(item.getStr(flagfield))) {
//                    return item;
//                }
//            }
//        }
