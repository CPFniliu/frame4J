//package com.cpfframe4j.util.common;
//
//import java.util.List;
//
//import org.apache.commons.lang3.StringUtils;
//
//import com.cpf.util.sql.SqlBuilder;
...
//
///**
// * 实施清单环节信息表对应的后台service
// *
// * @author CPF
// * @version [版本号, 2017-12-08 10:18:31]
// */
...
//    }
//
//    public ConvenientService(ICommonDao dao) {
//        baseDao = dao;
//    }
//
...
//     * @param key
//     */
//    public int deleteRecords(Class<? extends BaseEntity> baseClass, String field, String mapping) {
//        String tablename = SqlBuilder.getTablenameByClass(baseClass);
//        String sql = "DELETE FROM " + tablename + " WHERE " + field + " = ?1";
//        return baseDao.execute(sql, mapping);
//    }
//
//
//    /**
...
//     *  判断相关表相关字段是否有相应数据
//     */
//    public boolean hasData(String tablename, String field, Object mapping) {
//        return baseDao.queryBoolean(SqlBuilder.generateCountSql(tablename, generateSss(field)), mapping);
//    }
//
//    public boolean hasData(Class<? extends BaseEntity> baseClass, String field, Object mapping) {
//        return baseDao.queryBoolean(SqlBuilder.generateCountSql(baseClass, generateSss(field)), mapping);
//    }
//
//    /**
//     * ================================================================
